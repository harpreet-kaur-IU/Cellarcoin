...
const Telegram = () => {
  ...
  return (
    <svg onMouseEnter={hoverHandler} onMouseLeave={removeHandler} className={`${style["telegram-logo"]}`} width="56" height="48" viewBox="0 0 56 48"  fill="white" xmlns="http://www.w3.org/2000/svg">
