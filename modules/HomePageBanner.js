...
const HomePageBanner = () => {
  ...
  return (
    <div className={`container d-flex d-justify-space-between ${style["home-banner-container"]}`}>
      <div className={`col-6 ${style["home-banner-col-7"]}`}>
        ...
        <button onClick={exploreHandler} className={`cursor-pointer mt-32 btn-primary b-none font-20 f-500 l-137 ${style["btn-home-explore"]}`}>Explore</button>
      </div>
      <div className={`col-6 ${style["home-banner-col-3"]}`}>
