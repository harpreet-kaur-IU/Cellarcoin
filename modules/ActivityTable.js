                ...
                <div className={`${styles["table-wrapper"]}`}>
                    ...
                    {activity && activity.map((item)=>(
                        <div className={`${styles["table-column"]}`}>
                            ...
                            <span onClick={navigationHandler} className='cursor-pointer a-underline text-primary font-18 f-500 d-flex'>{item.from.name === null?"-":item.from.name}</span>
                            <span onClick={navigationHandler} className='cursor-pointer a-underline text-primary font-18 f-500 d-flex'>{item.to === null?"":item.to}</span>
                        ...
                        <div className={`d-none d-flex-column ${styles["table-column-sm"]}`}>
                            ...
                            <div className='d-flex d-justify-space-between'>
                                <div className='d-flex d-flex-column gap-1 mt-8'>
                                    ...
                                    <span onClick={navigationHandler} className='a-underline text-black font-16 f-500 l-137'>{item.from.name === null?"-":item.from.name}</span>
                                </div>
                                <div className='d-flex d-flex-column gap-1 mt-8'>
